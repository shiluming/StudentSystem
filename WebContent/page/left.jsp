		...
		<div class="sidebar-nav">
    		...
    		<div class="nav-header" data-toggle="collapse" data-target="#dashboard-menu"><i class="icon-dashboard"></i>管理员系统</div>
                ...
                <ul id="accounts-menu" class="nav nav-list collapse in">
                    <li ><a href="sign-in.html">个人信息管理</a></li>
                    ...
                    <li ><a href="reset-password.html">需审核信息管理</a></li>
                    <li ><a href="reset-password.html">未通过审核信息管理</a></li>
                </ul>
				</c:if>
                ...
                <ul id="settings-menu" class="nav nav-list collapse in">
                    <li ><a href="403.html">个人信息管理</a></li>
                    <li ><a href="${pageContext.request.contextPath}/stu/searchList.do">查询学生信息</a></li>
                    <li ><a href="500.html">需评审信息管理</a></li>
                    <li ><a href="503.html">未评审信息管理</a></li>
                </ul>
				</c:if>
				<c:if test="${loginUser.privilege=='admin' }">
