...
function saveTea() {
	...
	$.post("${pageContext.request.contextPath}/tea/saveTeacher.do?type=update",
			{
				'code':code,
				'tell':tell,
				'age':age,
...
<div class="btn-toolbar">
    <button class="btn btn-primary"><i class="icon-save"></i><a href="#" onclick="saveTea();"> 更新</a></button>
  <div class="btn-group">
  </div>
</div>
